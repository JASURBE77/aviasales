...
//           {/* Airlines */}
//           <div className="mb-3">
//             <p className="font-medium text-sm mb-1">Авиакомпании:</p>
//             {airlinesList.map((air) => (
//               <label key={air} className="flex items-center gap-2 text-sm mb-1">
//                 <input
//                   type="checkbox"
...
//               className="bg-blue-600 text-white px-3 py-2 rounded w-full mb-2 text-sm"
//             >
//               Применить
//             </button>
//             <button
...
//                 <div
//                   key={f.id}
//                   className="p-4 bg-white rounded-xl shadow flex justify-between items-center hover:shadow-lg transition-all"
//                 >
//                   <div>
...
//                     <div className="font-bold text-lg">{formatPrice(f.price)}</div>
//                     <button
//                       onClick={() => alert(`Вы выбрали: ${f.route}`)}
//                       className="bg-blue-600 text-white px-3 py-1 mt-2 rounded text-sm hover:bg-blue-700"
//                     >
//                       Купить
//                     </button>
//                   </div>
